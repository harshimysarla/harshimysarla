...
🏫 **Institute of Aeronautical Engineering** *(Expected Graduation: 2028)*
...
Become a Software Engineer at a leading product-based company while building impactful AI-powered applications.
...
| 🛡️ **[SentinelX AI Governance Firewall](https://github.com/harshimysarla/SentinelX-AI-Governance-Firewall)** | Enterprise AI governance and security platform that intercepts LLM requests, detects sensitive data and secrets, evaluates policies and risk, safely rewrites prompts, and routes requests through AI models. | `Next.js` `TypeScript` `MongoDB` `LLMs` `Cybersecurity` `AI` | [Repo](https://github.com/harshimysarla/SentinelX-AI-Governance-Firewall) |
| 🤖 **[OnboardAI](https://github.com/harshimysarla/OnboardAI)** | AI-powered employee onboarding and HR management platform with secure multi-tenant architecture, role-based access control, intelligent onboarding workflows, and document management. | `Next.js` `TypeScript` `MongoDB` `JWT` `Mongoose` `React` | [Repo](https://github.com/harshimysarla/OnboardAI) |
